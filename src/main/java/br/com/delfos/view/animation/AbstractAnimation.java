...
public class AbstractAnimation extends Transition{
	 ...
	 */
	public AbstractAnimation(final Node node, final Timeline timeline) {
	 ...
	 */
	public AbstractAnimation(final Node node, final Timeline timeline, final boolean useCache) {
		this.node = node;
