...
public class Main extends Application {
	...
	private final ObservableList<Typ> typData = FXCollections.observableArrayList(new Typ("Hund"), new Typ("Fuchs"),
	        new Typ("Esel"));
	private final ObservableList<Person> data = FXCollections.observableArrayList(
	        new Person("Jacob", typData.get(0), new Date()), new Person("Urs", typData.get(1), new Date()),
	        new Person("Hans", typData.get(2), new Date()), new Person("Ueli", typData.get(2), new Date()));
	...
	public void start(Stage stage) {
		...
		Callback<TableColumn<Person, String>, TableCell<Person, String>> cellFactory = (
		        TableColumn<Person, String> param) -> new EditingCell<Person>();
		...
		Callback<TableColumn<Person, Typ>, TableCell<Person, Typ>> comboBoxCellFactory = (
		        TableColumn<Person, Typ> param) -> new ComboBoxCellFactory<>(typData, new StringConverter<Typ>() {
			        ...
			        @Override
			        public String toString(Typ object) {
		...
		hb.getChildren().addAll(addFirstName, addLastName, addEmail, addButton, showButton);
		hb.setSpacing(3);
	...
	class DateEditingCell<T> extends TableCell<T, Date> {
	...
	public static class Person {
		...
		@Override
		public String toString() {
			return "Person [firstName=" + firstName.get() + ", typ=" + typ.get() + ", birthday=" + birthday.get() + "]";
		}
